            ...
            <div className="row">
                <div>
                    <form onSubmit={(e) => newItem(e)}>
                        <p className="title">{t("creator.create")}</p>
                        <div className="row">
                            <div>
                                <Input
                                    type="text"
                            ...
                            <div>
                                <label
                                    ...
                                    onClick={resetImages}
                                >
                                    {t("creator.reset_images")}
                                </label>
                                <button
                                    className="btn btn-danger btn-expanded"
                                    onClick={clearImages}
                                >
                                    {t("creator.clear_images")}
                                </button>
                            </div>
                            <div>
                                <textarea
                            ...
                            <div>
                                <Input
                                    ...
                                    name="discount"
                                    value={discountPrice}
                                    placeholder={t("creator.discount_price")}
                            ...
                            <div>
                                <Input
                                    ...
                                    placeholder={t("creator.discount_percent")}
                            ...
                            <div>
                                <Input
                                    ...
                                    name="boughtCount"
                                    value={boughtCount}
                                    placeholder={t("creator.bought_count")}
                            ...
                            <DropDown
                                ...
                                change={setCategory}
                                options={filters}
                                placeholder={t("creator.choose_category")}
                            />
                            <div>
                                <button
                ...
                <div className="item-preview">
                    <p className="title">{t("creator.preview")}</p>
