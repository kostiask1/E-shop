...
const Create = () => {
  const { deleteItemById, getFilters, filters, uploadItem } = useContext(
    catalogContext
  )
  ...
  const newFilter = (e) => {
    ...
    const data = filters.concat(value).filter((value) => value !== "Всё")
      ...
      <div className="container">
        <div className="row">
          <div className="btns-wrapper">
            {process.env.NODE_ENV === "development" && (
              <>
                ...
                <label
                  className="btn"
                  onClick={(e) =>
                    [1, 2, 3, 4, 5].forEach((counter) => createRandom(e))
                  }
                >
            ...
            <label className="btn btn-danger" onClick={getUncategorized}>
          ...
          <div className="form-wrapper">
            <form onSubmit={(e) => newFilter(e)} action="/">
              ...
              <button
                className={categoryToAdd ? "btn-success" : "disabled"}
                type="submit"
              >
                Добавить
              </button>
            ...
            <form onSubmit={(e) => deleteFilter(e)} action="/">
              ...
              />
              <button
                className={categoryToRemove ? "btn-danger" : "disabled"}
                type="submit"
              >
                Удалить
              </button>
          ...
          <div className="form-wrapper">
            <form onSubmit={(e) => blockByIp(e)} action="/">
              ...
              <div>
                <input
                  type="text"
                  value={whitelistIp}
                  onChange={(e) => handleWhitelistIp(e.target.value)}
                />
              </div>
              <button
                className={whitelistIp ? "btn-success" : "disabled"}
                type="submit"
              >
                Заблокировать
              </button>
            ...
            <form onSubmit={(e) => unblockByIp(e)} action="/">
              ...
              />
              <button
                className={unblockIp ? "btn-danger" : "disabled"}
                type="submit"
              >
                Разбанить
              </button>
